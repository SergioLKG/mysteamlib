...
- **Pendiente Fase 2**: verificación end-to-end en Vercel con usuario Steam real (login → biblioteca+logros poblados → cron → refresh). Cron ya probado por propietario (401 sin secret, CSRF ok).